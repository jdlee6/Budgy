...
const UpdateExpenseModal = ({ id }) => {
  const { updateExpenseModalVisible, closeModals } = useContext(ModalContext);
  ...
  const { updateExpense, updateExpenseData, categories, refetchUserBalances } = useContext(FinancialDataContext);
